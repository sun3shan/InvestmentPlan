/*
 * getNewDiscount_emxutil.h
 *
 * Code generation for function 'getNewDiscount_emxutil'
 *
 */

#ifndef __GETNEWDISCOUNT_EMXUTIL_H__
#define __GETNEWDISCOUNT_EMXUTIL_H__
...
/* End of code generation (getNewDiscount_emxutil.h) */
